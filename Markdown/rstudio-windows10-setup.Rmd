...
If you are unsure about any of this, [RTFM](https://chocolatey.org/install). *Chocolatey* can the be used from the *Command Prompt*, but always open it <span style="color:red">with administrative privileges</span>. 
...
* [*Git* 2.18.0](https://git-scm.com/): `choco install git`

* [*MiKTeX* 2.9.6753](https://miktex.org/): `choco install miktex`
