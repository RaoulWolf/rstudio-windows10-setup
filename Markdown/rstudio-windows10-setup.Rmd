...
This is a very rough and unofficial guide for setting up **R** and **RStudio** on a Windows 10 machine. The aim is to ensure as much functionality as possible, e.g., being able to install packages from source and using version control. 
...
* [**Git**](https://git-scm.com/) *2.18.0*: <https://git-scm.com/download/win>
...
* [**Inno Setup**](http://www.jrsoftware.org/isinfo.php) *5.6.1*: <http://www.jrsoftware.org/download.php/is.exe>
...
* [**R**](https://cloud.r-project.org/index.html) *3.5.1*: <https://cloud.r-project.org/bin/windows/base/R-3.5.1-win.exe>
...
**NOTE**: If you are using the [Chocolatey package manager](https://chocolatey.org/), you can install all necessary software from there, <span style="color:red">*except Rtools*</span>. Make sure to still follow the installation order mentioned below. 
...
## Install **Git**, **MiKTeX**, **Inno Setup** and **Strawberry Perl**
...
Install Rtools with all additional components. That means also ticking the box "Extras to build R itself: ICU, TexInfo, TclTk". Also, allow Rtools to create a link in your user's environment. 

## Install **RStudio**

# Adjust Your Account's Environment Variables
